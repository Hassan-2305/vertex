...
import { calcEMA, calcRSI, calcMACD, calcBollingerBands } from '../lib/indicatorEngine.js'
...
export default function BacktestPage() {
  ...
  return (
    <div className="h-full flex flex-col lg:flex-row fade-in">
      {/* Left Config Panel - 380px */}
      <div className="w-full lg:w-[380px] shrink-0 bg-[#111118] border-r border-white/[0.07] p-4 md:p-5 overflow-y-auto">
        <div className="mb-5">
